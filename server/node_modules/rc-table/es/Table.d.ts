...
declare function Table<RecordType extends DefaultRecordType>(tableProps: TableProps<RecordType>): JSX.Element;
...
declare type ImmutableTableType = typeof ImmutableTable & {
