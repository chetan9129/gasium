...
interface InternalCellProps<RecordType extends DefaultRecordType> extends Pick<TableContextProps, 'onHover'> {
    prefixCls?: string;
    className?: string;
    record?: RecordType;
...
export declare type CellProps<RecordType extends DefaultRecordType> = Omit<InternalCellProps<RecordType>, keyof Omit<TableContextProps, 'prefixCls'>>;
