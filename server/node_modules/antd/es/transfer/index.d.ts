...
declare const Transfer: {
    <RecordType extends TransferItem = TransferItem>(props: TransferProps<RecordType>): JSX.Element;
    displayName: string;
    List: {
        <RecordType_1 extends KeyWiseTransferItem>(props: TransferListProps<RecordType_1>): JSX.Element;
        displayName: string;
    };
