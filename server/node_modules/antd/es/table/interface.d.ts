...
export type RefTable = <RecordType extends object = any>(props: React.PropsWithChildren<TableProps<RecordType>> & {
    ref?: React.Ref<HTMLDivElement>;
}) => React.ReactElement;
export type RefInternalTable = <RecordType extends object = any>(props: React.PropsWithChildren<InternalTableProps<RecordType>> & {
    ref?: React.Ref<HTMLDivElement>;
}) => React.ReactElement;
