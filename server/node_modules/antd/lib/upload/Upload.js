...
const InternalUpload = (props, ref) => {
  ...
  const renderUploadList = (button, buttonVisible) => showUploadList ? /*#__PURE__*/React.createElement(_LocaleReceiver.default, {
    ...
    defaultLocale: _en_US.default.Upload
  }, contextLocale => {
    const {
      showRemoveIcon,
      showPreviewIcon,
  ...
  if (type === 'drag') {
    ...
    return wrapSSR( /*#__PURE__*/React.createElement("span", {
      className: (0, _classnames.default)(`${prefixCls}-wrapper`, rtlCls, className, hashId)
  ...
  if (listType === 'picture-card') {
    return wrapSSR( /*#__PURE__*/React.createElement("span", {
      className: (0, _classnames.default)(`${prefixCls}-wrapper`, `${prefixCls}-picture-card-wrapper`, rtlCls, className, hashId)
