...
const InternalMentions = (_a, ref) => {
  ...
  }, (0, _statusUtils.getStatusClassNames)(prefixCls, mergedStatus), !hasFeedback && className, hashId);
  const mentions = /*#__PURE__*/React.createElement(_rcMentions.default, Object.assign({
    ...
    onFocus: onFocus,
    onBlur: onBlur,
    dropdownClassName: (0, _classnames.default)(popupClassName, hashId),
    ref: mergedRef,
    options: mergedOptions
  }), getOptions());
  if (hasFeedback) {
    return /*#__PURE__*/React.createElement("div", {
      className: (0, _classnames.default)(`${prefixCls}-affix-wrapper`, (0, _statusUtils.getStatusClassNames)(`${prefixCls}-affix-wrapper`, mergedStatus, hasFeedback), className, hashId)
